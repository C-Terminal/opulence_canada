<script lang="ts">
	...
	let errorMessage = '';
	let isLoading = false;
	let registrationSuccess = page.url.searchParams.get('registered') === 'true';
...
<div class="login-container">
	...
	<form class="credentials-form text-black" on:submit|preventDefault={handleCredentialsSubmit}>
		{#if errorMessage}
