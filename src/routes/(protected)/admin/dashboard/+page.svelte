...
<div class="p-4">
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
    <div class="flex items-center w-full md:w-auto">
      ...
      <input type="text" placeholder="Search by account, merchant, date, category, or amount" class="ml-2 p-2 w-full md:w-96 rounded-lg border-gray-300 focus:ring-black focus:border-black" />
    </div>
